...
// Fix: Destructured `variant` and `size` props from the component arguments to ensure they are correctly typed and passed to the `buttonVariants` function. This resolves type errors.
